...
function Menu({ userName, userCode, activeSection = "Dashboard" }) {
    ...
    return (
        <>
            {/* Botão para abrir o menu (visível em telas pequenas) */}
            <button
            ...
            <div
                className={`
                    ...
                    md:translate-x-0 md:w-[20%] md:px-[5%] md:py-[5%]
                    w-[70%] px-[6%] py-[8%]
                `}
            ...
            >
                {/* Cabeçalho */}
                <div className="mb-[10%]">
                    <h1 className="text-3xl md:text-4xl font-bold text-green-800 mb-[10%]">SIGEF</h1>
