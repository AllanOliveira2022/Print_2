        ...
        <div className="w-full max-w-md p-8 space-y-8 bg-white rounded-lg shadow-md">
          ...
          <form className="mt-8 space-y-6">
            ...
            <div className="space-y-3">
              ...
              <button
                type="button"
                className="w-full py-2 px-4 border border-gray-300 rounded-lg shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-colors duration-200"
              >
                Criar nova conta
              </button>
            </div>
