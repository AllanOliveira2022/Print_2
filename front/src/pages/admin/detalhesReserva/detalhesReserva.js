...
import { FaArrowLeft, FaCalendar, FaClock, FaMapMarkerAlt, FaUser, FaInfoCircle } from "react-icons/fa";
...
function DetalhesReservaAdmin() {
    ...
    try {
      ...
      try {
        ...
        if (
          ...
          const todas = await reservaService.listarSolicitacoes();
  ...
  const getStatusStyle = (status) => {
    switch (status?.toLowerCase()) {
      ...
      case "redirecionada":
      case "redirecionado":
        return "bg-blue-100 text-blue-800 border-blue-300 uppercase rounded-none";
      default:
        return "bg-gray-100 text-gray-800 border-gray-300 uppercase rounded-none";
    }
  };
...
export default DetalhesReservaAdmin;
